...
const AdminRevenuePage = () => {
  ...
  return (
    <div className="p-8 bg-gray-50 min-h-screen">
      <h1 className="text-2xl font-bold mb-6">Admin Revenue Dashboard</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white p-6 rounded-lg shadow flex flex-col items-center">
          ...
          <div className="mt-1 text-xs text-gray-400">(Admin Revenue)</div>
        </div>
      </div>
      ...
      <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded">
        <p className="text-sm text-blue-800">
          Note: The revenue displayed represents the total platform fee
          collected by the admin from all bookings.
        </p>
      </div>
    </div>
  );
